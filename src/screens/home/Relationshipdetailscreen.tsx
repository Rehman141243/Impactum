...
// import { ArrowLeft, Send, Trash2, Sparkle, Crown, MessageCircleHeart } from 'lucide-react-native';
...
//           borderWidth: 2,
//           // Border matches the app bg so the dot reads as "cut out" of the ring;
//           // needs the literal current-mode color since it's a native style prop.
...
//               fontFamily: "serif",
//             }}
//             className="text-brand-textPrimary">
//             {initial}
//           </AppText>
...
//       className="bg-brand-bgCardSoft border border-brand-borderSoft rounded-card p-card">

//       <View className="flex-row items-center justify-between mb-4">
//         <AppText className="font-sansMedium text-caption text-brand-blueSoft uppercase tracking-[2px]">
//           Harmony
//         </AppText>
...
//       {/* Progress track */}
//       <View
//         className="h-2.5 bg-brand-borderSoft rounded-full overflow-hidden"
...
//               <Defs>
//                 <LinearGradient id="harmonyFill" x1="0" y1="0" x2="1" y2="0">
//                   <Stop offset="0%" stopColor="#4F7BF7" stopOpacity={1} />
//                   <Stop offset="70%" stopColor="#4F7BF7" stopOpacity={1} />
//                   <Stop offset="100%" stopColor="#4F7BF7" stopOpacity={0.35} />
//                 </LinearGradient>
//               </Defs>
//               <Rect x={0} y={0} width={trackWidth} height="100%" fill="url(#harmonyFill)" rx={999} />
//             </Svg>
//           )}
//         </Animated.View>
...
//         {['25', '50', '75', '100'].map(v => (
//           <AppText key={v} className="font-sans text-[11px] text-brand-textMuted">
//             {v}
//           </AppText>
//         ))}
//       </View>

//       <AppText className="font-sans text-body-sm text-brand-textMuted mt-4 leading-5">
...
//         disabled={!onPress}
//         className="bg-brand-bgCardSoft border border-brand-borderSoft rounded-2xl p-4 flex-row items-center gap-3"
//         style={{ minHeight: 72 }}>
//         <View
//           className="w-10 h-10 rounded-full bg-brand-bgMain border border-brand-borderSoft items-center justify-center"
//           style={{
//             shadowColor: '#4F7BF7',
//             shadowOffset: { width: 0, height: 0 },
//             shadowOpacity: 0.2,
...
//         </View>
//         <AppText
//           className="font-sansMedium text-body-md text-brand-textPrimary flex-1"
//           numberOfLines={1}>
//           {name}
//         </AppText>
//       </Pressable>
...
//   const accentColor = locked ? '#C9A84C' : '#4F7BF7';
...
//           ) : (
//             <MessageCircleHeart size={20} color="#fff" />
//           )}
//           <AppText className="font-sansSemiBold text-body-md text-white">
...
//       <View className="w-px h-16 bg-brand-borderSoft" />
//       <AnimatedView style={glowStyle}>
//         <AppText style={{ fontSize: 26, color: '#C9A84C', marginVertical: 4 }}>∞</AppText>
//       </AnimatedView>
//     </View>
//   );
// }
...
//             <Sparkle color={'#4F7BF7'} size={14} />
//             <AppText className="font-sansMedium text-brand-textMuted uppercase tracking-[2px]">
...
//             style={{ backgroundColor: isPending ? '#3D3420' : '#1A3D2A' }}>
//             <View
//               className="w-2 h-2 rounded-full"
//               style={{ backgroundColor: isPending ? '#F97316' : '#22C55E' }}
//             />
//             <AppText
//               className="font-sansMedium text-caption"
//               style={{ color: isPending ? '#F97316' : '#22C55E' }}>
...
//             className="mx-5 mb-6 bg-brand-bgCardSoft border border-brand-borderSoft rounded-2xl px-4 py-4 flex-row items-center justify-between">
//             <View className="flex-row items-center gap-3 flex-1">
//               <View className="w-9 h-9 rounded-full bg-[#3D3420] items-center justify-center">
//                 <Send size={16} color="#F97316" />
//               </View>
//               <View className="flex-1">
//                 <AppText className="font-sansMedium text-body-md text-brand-textPrimary">
//                   Pending invitation
//                 </AppText>
//                 <AppText className="font-sans text-caption text-brand-textMuted mt-0.5">
//                   hasn't accepted yet
//                 </AppText>
//               </View>
//             </View>
...
//               style={{ borderColor: '#C9A84C', backgroundColor: '#3D3420' }}>
//               <Send size={13} color="#C9A84C" />
//               <AppText className="font-sansMedium text-caption" style={{ color: '#C9A84C' }}>
...
//             size={120}
//             ringColor={isPending ? '#C9A84C' : '#22C55E'}
//             statusColor={isPending ? '#C9A84C' : '#22C55E'}
//             label={partnerName}
//             sublabel="Partner"
//             dimmed={isPending}
...
//           <PersonCard initial={myInitial} name={myName} onPress={goToMyProfile} delay={200} />
//           <PersonCard initial={partnerInitial} name={partnerName} onPress={goToPartnerProfile} delay={300} />
//         </View>
...
//             disabled={deleting}
//             className="flex-row items-center justify-center gap-2 py-4 rounded-2xl border border-red-900">
//             <Trash2 size={18} color="#EF4444" />
//             <AppText className="font-sansMedium text-body-md text-red-500">
